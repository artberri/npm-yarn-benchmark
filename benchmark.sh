...
libraries=('angular' 'ember' 'react' 'vue' 'svelte')
tools=('npm' 'yarn')
base_dir=$PWD
...
show_results() {
    ...
    awk 'BEGIN {printf("| %24s | %12s | %12s | %12s | %12s | %12s | \n" , " ", "'${libraries[0]}'", "'${libraries[1]}'", "'${libraries[2]}'", "'${libraries[3]}'", "'${libraries[4]}'")}
        {printf("| %24s | %12.3f | %12.3f | %12.3f | %12.3f | %12.3f | \n", $1, $2, $3, $4, $5, $6)}' $all_file
